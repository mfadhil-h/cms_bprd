            ...
            <div class="box box-default">
                <div class="box-body">
                    <form name="frmReportTransaction" id="frmReportTransaction" class="form-horizontal" action="<?php echo base_url('report/transaction_report_pdf') ?>" method="post">
                        ...
                        <button type="submit" name="btnTransactionPpdf" href="<?php echo base_url("ReportTransaction/print_report") ?>" id="btnTransactionPpdf" class="btn btn-danger">Export Data(.PDF)</button>
            ...
            <div class="col-lg-12">
                <div class="box box-info">
                    <div class="box-body table-responsive">
                        <table id="report_transaction" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                            <thead>
                                <tr>
                                    <th>Wajib Pajak</th>
                                    <th>Outlet</th>
